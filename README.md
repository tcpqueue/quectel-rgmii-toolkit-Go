...
| `changeLoginPassword()` | 校验当前密码、新密码和确认密码，调用后端接口修改登录密码。 |
...
| `dispatchAPIWebSocketRequest()` | 将 WebSocket 消息转换为内部 HTTP request，并调用对应业务 handler。 |
